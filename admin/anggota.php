...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
							  ...
							  if(empty($hal)){
								...
								$sql_plgn = mysql_query("select * from tbl_anggota LIMIT $posisi,$batas")or die(mysql_error());
								
								
								 if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	                $sql_plgn=mysql_query("SELECT * FROM  tbl_anggota 
	               where nrp like '%$qcari%'
	               or nama like '%$qcari%'  ");
                    }
                    ...
                    { ?-->
										<tbody>
										<tr>
										<td><a href="anggota-detail.php?hal=edit&kd=<?php echo $data['nrp'];?>"><?php echo $data['nrp']; ?></a></td>
				 ...
				 <?php $tampil=mysql_query("select * from tbl_anggota ");
                    ...
                    ?>
                  <center><h4>Jumlah Total Anggota : <?php echo "$user"; ?> Orang </h4> </center>
