...
<?php } ?>
                ...
                <section class="content">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <form action="kategori-anggota.php" method="POST">
                                        ...
                                        <input type='text' class="form-control input-sm pull-right" style="width: 150px;"  name='qcari' placeholder='Cari berdasarkan Kategori Anggota' required /> 
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit kategori Anggota" href="kategori-anggota-edit.php?hal=edit&kd=<?php echo $data['id_kategori_anggota'];?>">Edit</a>
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['kategori_anggota'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus kategori Anggota" href="kategori-anggota-hapus.php?hal=hapus&kd=<?php echo $data['id_kategori_anggota'];?>"><!--span class="glyphicon glyphicon-trash"-->Hapus</a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
