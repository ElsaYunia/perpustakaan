  ...
  <div class="slider-wrapper">
    ...
    <div id="da-slider" class="da-slider">
      <div class="da-slide">
        ...
        <div class="da-img"><img src="dashboard/img/parallax-slider/kaos.png" alt="image01" /></div>
      </div>
      <div class="da-slide">
  ...
  <div id="wrapper">
    ...
    <!--start: Container -->
      <div class="container">
          ...
          <div class="hero-unit">
            <p>
          Kami adalah library online terlengkap dan terpercaya....
        </p>
            <p><a class="btn btn-success btn-large" href="produk.php">Mulai Pinjam &raquo;</a></p>
...
<!---->
      ...
      <div class="clients-carousel">
        ...
        <ul class="slides clients">
          <li><img src="dashboard/img/logos/1.png" alt=""/></li>
          <li><img src="dashboard/img/logos/2.png" alt=""/></li>  
          <li><img src="dashboard/img/logos/3.png" alt=""/></li>
          <li><img src="dashboard/img/logos/4.png" alt=""/></li>
          <li><img src="dashboard/img/logos/5.png" alt=""/></li>
          <li><img src="dashboard/img/logos/6.png" alt=""/></li>
          <li><img src="dashboard/img/logos/7.png" alt=""/></li>
          <li><img src="dashboard/img/logos/8.png" alt=""/></li>
          <li><img src="dashboard/img/logos/9.png" alt=""/></li>
          <li><img src="dashboard/img/logos/10.png" alt=""/></li>   
        </ul>
  ...
  <div id="copyright">
    ...
    <div class="container">
      ...
      <p>
        Copyright &copy; <a href="http://www.grahabacaonline.com">E-Library Trend</a> <a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> designed by BootstrapMaster
      </p>
