    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <div class="culmn">
            ...
            <div id="contentpane" class="article">
                <div class="container">
                 <div class="heading">
                <h2 class="bebas">Kontak Kami</h2>
           </div>
        <hr/>
                <address>
                  Untuk respon cepat, silahkan hubungi kami melalui email atau telepon:<br> <i class="fa fa-envelope"></i> webkelompok497@gmail.com.com <br><i class="fa fa-phone"></i> 0272 122 344
                  <br>
                  <i class="fa fa-location-arrow"></i> Jalan Raya Janti, Bantul, Yogyakarta.
                </address>
</ol>
                <p>&nbsp;</p>
        </div>
